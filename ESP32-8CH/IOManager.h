...
private:
    ...
    // Pinos (seguindo padrão do 4canaisEth)
    const uint8_t inputPins[NUM_INPUTS] = {
        INPUT_1_PIN, INPUT_2_PIN, INPUT_3_PIN, INPUT_4_PIN,
        INPUT_5_PIN, INPUT_6_PIN, INPUT_7_PIN, INPUT_8_PIN
    };
    const uint8_t outputPins[NUM_OUTPUTS] = {
        OUTPUT_1_PIN, OUTPUT_2_PIN, OUTPUT_3_PIN, OUTPUT_4_PIN,
        OUTPUT_5_PIN, OUTPUT_6_PIN, OUTPUT_7_PIN, OUTPUT_8_PIN
    };
};
